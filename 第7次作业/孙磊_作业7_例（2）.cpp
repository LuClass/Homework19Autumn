...
int main()
{
  ...
  switch(i/100000){ //Õû³ý 
  	case 0:bonus=i*0.1; break;
  	case 1:bonus=bonus1+(i-100000)*0.075; break;
  	
  	case 2:bonus=bonus2+(i-200000)*0.05; break;
  	case 3:bonus=bonus2+(i-200000)*0.05; break;
  	
  	case 4:bonus=bonus4+(i-400000)*0.03; break;
  	case 5:bonus=bonus4+(i-400000)*0.03; break;
  	
  	case 6:bonus=bonus6+(i-600000)*0.015;break;
  	case 7:bonus=bonus6+(i-600000)*0.015;break;
  	case 8:bonus=bonus6+(i-600000)*0.015;break;
